...
class ConnectionModeIndicator extends BufferedBitmapDrawable {
    ...
    // current connection mode. Invoked by ConnectionManager
    ...
    // Used by the ConnectionManager when the mode changes
    ...
    public function initialize( location as Location ) {
        ...
        if( Config.UI_SCREEN_SHAPE == Toybox.System.SCREEN_SHAPE_RECTANGLE ) {
            ...
            setLocation( 
                ...
                Config.UI_SCREEN_HEIGHT * locYFactor
            );
        }
    }
